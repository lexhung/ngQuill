            ...
            return $templateCache.put('ngQuill/template.html',
                '<div id="content-container">' +
                    '<div class="advanced-wrapper">' +
                        '<div class="toolbar-wrapper" ng-if="toolbar">' +
                            '<div class="toolbar toolbar-container" ng-show="toolbarCreated && showToolbar">' +
                        ...
                        '<input class="ng-hide" type="text" ng-model="modelLength" ng-if="required" ng-pattern="/^([2-9]|[1-9][0-9]+)$/">' +
                    '</div>' +
                '</div>');
        }
    ]);
